<?php /* Smarty version Smarty-3.1.19, created on 2015-10-15 15:21:58
         compiled from "/home/alejandro1711/public_html/soygarota/themes/default-bootstrap/history.tpl" */ ?>
<?php /*%%SmartyHeaderCode:586869842561fc496051eb4-66874147%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '99a4be1af13f39556122a2d5cbf0b3f17623002a' => 
    array (
      0 => '/home/alejandro1711/public_html/soygarota/themes/default-bootstrap/history.tpl',
      1 => 1444917362,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '586869842561fc496051eb4-66874147',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_561fc4962661a2_28931762',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_561fc4962661a2_28931762')) {function content_561fc4962661a2_28931762($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include '/home/alejandro1711/public_html/soygarota/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp71=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order-opc',true,null,"submitReorder&id_order=".$_tmp71), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php } else { ?>
								<a class="link-button" href="<?php ob_start();?><?php echo intval($_smarty_tpl->tpl_vars['order']->value['id_order']);?>
<?php $_tmp72=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('order',true,null,"submitReorder&id_order=".$_tmp72), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Reorder'),$_smarty_tpl);?>
">
							<?php }?>
