...
class Leobootstrapmenu extends Module
{
    ...
    public function install()
    {
        ...
        if (parent::install() &&
                ...
                && Configuration::updateValue('LEO_MEGAMENU_CAVAS', 0)
...
//        }
        ...
        if (Tools::isSubmit('save'.$this->name) && Tools::isSubmit('active')) {
            ...
            if ($megamenu->validateFields(false) && $megamenu->validateFieldsLang(false)) {
                ...
                Tools::redirectAdmin(AdminController::$currentIndex.'&configure=leobootstrapmenu&successful=1&save'.$this->name.'&token='.Tools::getValue('token').'&id_btmegamenu='.$megamenu->id);
            } else {
                # validate module
                $errors = array();
...
//				),
        ...
        $html = $this->_html.'<div class="col-lg-12"> <div class="" style="float: right"><div class="pull-right"><a href="'.$live_editor_url.'" class="btn btn-danger"> '
                ...
                .'<hr><p><input type="button" value="'.$this->l('New Menu Item').'" id="addcategory" data-loading-text="'.$this->l('Processing ...').'" class="btn btn-danger" name="addcategory">
					...
					<hr><p><input type="button" value="'.$this->l('Update').'" id="show_cavas" data-loading-text="'.$this->l('Processing ...').'" class="btn btn-info" ></p>
						...
						<select name="show_cavas" class="show_cavas">
							<option value="1" '.((isset($show_cavas) && $show_cavas == 1) ? 'selected' : null).'>'.$this->l('Yes').'</option>
							<option value="0" '.((isset($show_cavas) && $show_cavas == 0) ? 'selected' : null).'>'.$this->l('No').'</option>
						</select>
