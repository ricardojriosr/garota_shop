...
<div id="search_block_top" class="pull-right">
	<a  class="groupe-btn dropdown hidden-md hidden-lg" title="{l s='Search' mod='blocksearch'}" href="#"><i class="fa fa-search"></i></a>
	<form id="searchbox" method="get" action="{$link->getPageLink('search', null, null, null, false, null, true)|escape:'html':'UTF-8'}" class="groupe" >
