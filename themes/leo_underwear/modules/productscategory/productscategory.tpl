...
<div class="page-product-box blockproductscategory products_block block ">
	...
	<div id="productscategory_list" class="clearfix product_list grid">
		...
		<div class=" carousel slide" id="{$tabname}">
			...
			<a class="carousel-control left" href="#{$tabname}" data-slide="prev">{l s='prev' mod='productscategory'}</a>
			<a class="carousel-control right" href="#{$tabname}" data-slide="next">{l s='next' mod='productscategory'}</a>
			{/if}
